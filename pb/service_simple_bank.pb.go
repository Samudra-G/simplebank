...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\x1a\x15rpc_create_user.proto\x1a\x16rpc_verify_email.proto\x1a\x15rpc_update_user.proto\x1a\x14rpc_login_user.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\x90\x05\n" +
	"\n" +
	"SimpleBank\x12\xa5\x01\n" +
	"\n" +
	"CreateUser\x12\x15.pb.CreateUserRequest\x1a\x16.pb.CreateUserResponse\"h\x92AK\x12\vCreate User\x1a<Use this API to create a new user in the Simple Bank system.\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/create_user\x12\xa4\x01\n" +
	"\tLoginUser\x12\x14.pb.LoginUserRequest\x1a\x15.pb.LoginUserResponse\"j\x92AN\x12\n" +
	"Login User\x1a@Use this API to login user and get the Access and Refresh token.\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/login_user\x12\x9f\x01\n" +
	"\n" +
	"UpdateUser\x12\x15.pb.UpdateUserRequest\x1a\x16.pb.UpdateUserResponse\"b\x92AE\x12\vUpdate User\x1a6Use this API to update user in the Simple Bank system.\x82\xd3\xe4\x93\x02\x14:\x01*2\x0f/v1/update_user\x12\x90\x01\n" +
	"\vVerifyEmail\x12\x16.pb.VerifyEmailRequest\x1a\x17.pb.VerifyEmailResponse\"P\x92A5\x12\fVerify Email\x1a%Use this API to user's email address.\x82\xd3\xe4\x93\x02\x12\x12\x10/v1/verify_emailB\x7f\x92AX\x12V\n" +
	"\vSimple Bank\"B\n" +
	"\tSamudra G\x12\x1chttps://github.com/Samudra-G\x1a\x17samudramukhar@gmail.com2\x031.2Z\"github.com/Samudra-G/simplebank/pbb\x06proto3"
