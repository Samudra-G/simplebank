DB_URL = postgres://root:secret@localhost:5431/simple_bank?sslmode=disable

postgres:
	docker run --name postgres15 --network bank-network -e POSTGRES_PASSWORD=secret -e POSTGRES_USER=root -p 5431:5432 -d postgres:15-alpine
